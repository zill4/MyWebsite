<script>
	...
	const me = {
		...
		age: 23,
		gender: 'M',
		bio: 'I like to program with Svelte, Unity, and Bixby.'
	};
 ...
 <div class="row">
	...
	<div class="col-6 col-s-9">
			...
			<p class="par">
			Thanks for visiting my website! I love building cool projects, working with passionate people, and challenging the status quo.
